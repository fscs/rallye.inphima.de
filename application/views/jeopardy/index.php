<div id="wrapper">
	<div class="categories clearfix">
		<div>Nerds<br />only</div>
		<div>Welt der<br />Zahlen</div>
		<div>Quarks<br />&amp; Co.</div>
		<div>Rund um<br />die Uni</div>
	...
	<div class="questions clearfix">
		...
		<div class="tile"><p class="question">Er spielte den Unternehmer Eduardo Serverin im Film <br/>"The Social Network"</p><p class="answer">Wer ist Andrew Garfield? </p><p class="points">200</p></div>
		<div class="tile"><p class="question">In dieser "geometrischen Figur" sind die Binominalkoeffizienten enthalten.</p><p class="answer">Was ist das Pascalsche Dreieck?</p><p class="points">200</p></div>
		<div class="tile"><p class="question">Unter diesem Winkel würde ein Geschoss in einem fiktiven Vakuum auf der Erde exakt null Meter weiter fliegen.</p><p class="answer">Was sind 90 Grad (oder (180k+90) Grad, mit k ganzzahlig)?</p><p class="points">200</p></div>
		<div class="tile"><p class="question">Als Limonade mit erhöhtem Koffeingehalt ersetzte sie in der Fachschaft Informatik sämtliche Grundnahrungsmittel</p><p class="answer">Was ist Volt?</p><p class="points">200</p></div>
		<div class="tile"><p class="question">Dieser sarkastische Negativpreis wird an Menschen verliehen, die sich selbst von der Evolution ausschließen.</p><p class="answer">Was ist der Darwin-Award?</p><p class="points">200</p></div>


		<div class="tile"><p class="question">rm -rf /</p><p class="answer">Wie lösche ich alle Dateien?</p><p class="points">300</p></div>
		...
		<div class="tile"><p class="question">Die Wahrscheinlichkeit hierfür beträgt <br/><math><mrow>
					<mn>4</mn>
					<mo>*</mo>
					<mfrac><mn>1</mn>
						<mrow>
   <mo> ( </mo>
		...
		<div class="tile"><p class="question">Mit diesem Polynom lässt sich jede beliebig oft differenzierbare Funktion beliebig genau approximieren.</p><p class="answer">Was ist das Taylor-Polynom?</p><p class="points">500</p></div>
		<div class="tile"><p class="question">Er wollte mit Hilfe von Parabolspiegeln eine Flotte versenken.</p><p class="answer">Wer war Archimedes?</p><p class="points">500</p></div>
		<div class="tile"><p class="question">So wird das Gebäude der Wirtschaftswissenschaftlichen Fakultät der HHU genannt.</p><p class="answer">Was ist das Oeconomicum?</p><p class="points">500</p></div>
		<!--<div class="tile"><p class="question">Es ist das einzige Alphabet in lateinischer Ausgangsschrift mit lediglich 12 Buchstaben.</p><p class="answer">Was ist das Hawaiianische Alphabet?</p><p class="points">500</p></div> -->
		<div class="tile"><p class="question">Llanfairpwllgwyngyllgoger - ychwyrndrobwllllantysiliogogogoch </p><p class="answer">Was ist der längste Ortsname der Welt und bedeutet Marienkirche in einer Mulde weißer Haseln in der Nähe eines schnellen Wirbels und der Thysiliokirche bei der roten Höhle?</p><p class="points">500</p></div>
	</div>
	<p>Eure Punktezahl: <span id="result">0</span></p>
	<p>Keys: P=Sound, K=Korrekt, F oder U=Falsch, Pfeiltaste=Auflösen</p>
</div>
